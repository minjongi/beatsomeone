...
module.exports = {
    ...
    configureWebpack: {
        ...
        entry: {
            ...
            terms: ['./views/register/basic/terms.js'],
            policy: ['./views/register/basic/policy.js'],
            ...
            m_terms: ['./views/register/mobile/terms.js'],
            m_policy: ['./views/register/mobile/policy.js'],
