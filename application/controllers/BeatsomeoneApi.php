...
//        }
    ...
    public function merge_item()
    {
        ...
        $form = array(
            ...
            'licenseLeasePriceJPY' => $this->input->post('licenseLeasePriceJPY'),
            'licenseLeasePriceCNY' => $this->input->post('licenseLeasePriceCNY'),
            ...
            'licenseStemPriceJPY' => $this->input->post('licenseStemPriceJPY'),
            'licenseStemPriceCNY' => $this->input->post('licenseStemPriceCNY'),
