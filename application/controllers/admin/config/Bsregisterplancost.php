		...
		if ($this->form_validation->run() === false) {
            ...
            $d = array(
                array(
                    ...
                    'monthly_jpy' => $this->input->post('m_monthly_jpy'),
                    'monthly_cny' => $this->input->post('m_monthly_cny'),
                    'yearly' => $this->input->post('m_yearly'),
                    'yearly_d' => $this->input->post('m_yearly_d'),
                    'yearly_jpy' => $this->input->post('m_yearly_jpy'),
                    'yearly_cny' => $this->input->post('m_yearly_cny'),
                    ...
                    'yearly_discount_amt_jpy' => $this->input->post('m_yearly_discount_amt_jpy'),
                    'yearly_discount_amt_cny' => $this->input->post('m_yearly_discount_amt_cny'),
                ),
                array(
                    'plan' => $this->input->post('p_plan'),
                    'monthly' => $this->input->post('p_monthly'),
                    'monthly_d' => $this->input->post('p_monthly_d'),
                    'monthly_jpy' => $this->input->post('p_monthly_jpy'),
                    'monthly_cny' => $this->input->post('p_monthly_cny'),
                    'yearly' => $this->input->post('p_yearly'),
                    'yearly_d' => $this->input->post('p_yearly_d'),
                    'yearly_jpy' => $this->input->post('p_yearly_jpy'),
                    'yearly_cny' => $this->input->post('p_yearly_cny'),
                    ...
                    'yearly_discount_amt_jpy' => $this->input->post('p_yearly_discount_amt_jpy'),
                    'yearly_discount_amt_cny' => $this->input->post('p_yearly_discount_amt_cny'),
                ),
            );
