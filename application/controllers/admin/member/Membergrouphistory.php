...
class Membergrouphistory extends CB_Controller {
     ...
     * 페이지 이동시 필요한 정보입니다
     */
    public $pagedir = 'member/membergrouphistory';

    /**
     * 모델을 로딩합니다
     */
    protected $models = array('Membergroup_history');

    /**
     * 이 컨트롤러의 메인 모델 이름입니다
     */
    protected $modelname = 'Membergroup_history_model';
    ...
    function __construct()
    {
         ...
         * 라이브러리를 로딩합니다
         */
        $this->load->library(array('querystring', 'pagination'));
    }
    ...
    public function index() {
         ...
         */
        $search_option = array('mmpl_datetime' => '날짜', 'plan_name' => '플랜명', 'pay_method' => '지불방식');
