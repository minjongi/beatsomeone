        ...
        if ($this->member->is_member()) {
            ...
            if ($mem_id) {
                ...
                if ($social_type === 'facebook') {
                    ...
                    $avatar = element('picture', $socialinfo);
                    $email = element('email', $socialinfo);
                    $first_name = element('givenName', $socialinfo);
                    $last_name = element('familyName', $socialinfo);
                    ...
                    $nickname = preg_replace('/\s+/', '', $nickname);
                    $email = element('email', $socialinfo);
                    $first_name = element('name', $socialinfo);
                ...
                $insertdata['mem_firstname'] = $first_name;
                $insertdata['mem_lastname'] = $last_name;
