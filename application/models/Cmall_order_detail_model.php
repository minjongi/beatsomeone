...
class Cmall_order_detail_model extends CB_Model
{
	...
	public function get_detail_by_item($cor_id = 0, $cit_id = 0)
	{
		...
		$this->db->select('cmall_item_detail.*, cmall_order_detail.cod_id, cmall_order_detail.cod_count, cmall_order_detail.cod_download_days, cmall_order_detail.cod_status, cmall_order_detail.cod_point, cmall_order_detail.cod_seller_usertype, cb_member_group.mgr_description');
		$this->db->from('cmall_order_detail');
		$this->db->join('cmall_item_detail', 'cmall_order_detail.cde_id = cmall_item_detail.cde_id', 'inner');
        $this->db->join('cb_member_group', 'cmall_order_detail.cod_seller_usertype = cb_member_group.mgr_id', 'left');
