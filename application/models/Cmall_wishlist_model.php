...
class Cmall_wishlist_model extends CB_Model
{
	...
	{
		$select = 'cmall_wishlist.*, cmall_item.cit_name, cmall_item.cit_key, cmall_item.cit_file_1, cmall_item.cit_freebeat, cmall_item.cit_lease_license_use, cmall_item.cit_mastering_license_use, cmall_item.cit_include_copyright_transfer, cmall_item.cit_officially_registered, cmall_item_detail.cde_id as preview_cde_id,m.mem_nickname';
		$join[] = array('table' => 'cmall_item', 'on' => 'cmall_wishlist.cit_id = cmall_item.cit_id', 'type' => 'inner');
