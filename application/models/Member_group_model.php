			...
			foreach (element('mgr_id', $data) as $key => $value) {
				...
				if ($value) {
					...
					$updatedata = array(
                        ...
                        'mgr_monthly_cost_jpy' => $data['mgr_monthly_cost_jpy'][$key],
                        'mgr_monthly_cost_cny' => $data['mgr_monthly_cost_cny'][$key],
                        'mgr_year_cost_d' => $data['mgr_year_cost_d'][$key],
                        'mgr_year_cost_w' => $data['mgr_year_cost_w'][$key],
                        'mgr_year_cost_jpy' => $data['mgr_year_cost_jpy'][$key],
                        'mgr_year_cost_cny' => $data['mgr_year_cost_cny'][$key],
