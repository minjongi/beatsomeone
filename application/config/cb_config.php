...
$config['install_ip'] = '121.133.140.199'; // 여기에 all 이라고 적으면, 모든 IP 에서 접근 가능합니다, 간혹 localhost 에 설치할 때에 ip 체크를 제대로 하지 못한 경우를 대비합니다.
...
$config['email_smtp_user'] = 'beatsomeone@daum.net';
$config['email_smtp_pass'] = 'ejaeja12!@';
