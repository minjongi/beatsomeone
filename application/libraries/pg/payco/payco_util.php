...
// $mData - JSON 데이터
//-------------------------------------------------------------------------------
function payco_reserve($URL_reserve, $mData){
...
// $mData - JSON 데이터
//---------------------------------------------------------------------------------
function payco_cancel_check($URL_cancel_check, $mData){
...
// $mData - JSON 데이터
//---------------------------------------------------------------------------------
function payco_approval($URL_approval, $mData){
...
// $mData - JSON 데이터
//---------------------------------------------------------------------------------
function payco_cancel($URL_cancel, $mData){
...
// $mData - JSON 데이터
//---------------------------------------------------------------------------------
function payco_upstatus($URL_upstatus, $mData){
...
// $mData - JSON 데이터
//---------------------------------------------------------------------------------
function payco_cancelmileage($URL_cancelMileage, $mData){
...
// $mData - JSON 데이터
//---------------------------------------------------------------------------------
function payco_keycheck($URL_checkUsability, $mData){
...
// $mData - JSON 데이터
//---------------------------------------------------------------------------------
function payco_detailForVerify($URL_detailForVerify, $mData){
