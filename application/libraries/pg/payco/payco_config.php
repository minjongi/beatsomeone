...
$sellerKey				= "V4MTUT"			;									//(필수) 가맹점 코드 - 파트너센터에서 알려주는 값으로, 초기 연동 시 PAYCO에서 쇼핑몰에 값을 전달한다.
$cpId					= "V4MTUT"		;									//(필수) 상점ID, 30자 이내
$productId				= "V4MTUT_EASYP"		;									//(필수) 상품ID, 50자 이내
...
$AppWebPath = "https://beatsomeone.com/payco/";
