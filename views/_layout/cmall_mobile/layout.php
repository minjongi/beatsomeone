	...
	<nav class="navbar">
		<div class="container">
			<div class="logo pull-left">
				<a href="<?php echo site_url('cmall'); ?>" title="<?php echo html_escape($this->cbconfig->item('site_title'));?>"><?php echo $this->cbconfig->item('cmall_name') ? html_escape($this->cbconfig->item('cmall_name')) : $this->cbconfig->item('site_logo'); ?></a>
			</div>
