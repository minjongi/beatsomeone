<template>
    <div class="row">
        ...
        <div class="data">
            ...
            <button class="btn btn--blue right active" v-if="!isEmailEditing" @click="setEmailEdit(true)">
                Change
            </button>
            <button class="btn btn--blue right active" v-if="isEmailEditing" @click="doSubmit">
                Save
            </button>
            <button class="btn btn--gray right" style="right: 80px !important;" v-if="isEmailEditing"  @click="setEmailEdit(false)">
                Cancel
            </button>
