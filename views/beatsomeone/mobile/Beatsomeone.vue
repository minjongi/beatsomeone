    ...
    <div>
        <div v-if="popup">
          ...
          <div class="noti-content">
            <div>
              <a href="/event"><img :src="'/assets_m/images/event/210110/' + $i18n.locale + '/1.png'"></a>
            </div>
            <div>
              <img :src="'/assets_m/images/event/210110/' + $i18n.locale + '/2.png'" @click="closePopup(true)" style="width:50%;"><img :src="'/assets_m/images/event/210110/' + $i18n.locale + '/3.png'" @click="closePopup()" style="width:50%;">
            </div>
          </div>
        </div>
        <div class="wrapper">
