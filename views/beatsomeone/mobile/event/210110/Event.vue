    ...
    <div>
        <div class="wrapper">
            ...
            <div class="container sub event-content">
              ...
              <div><a :href="helper.langUrl($i18n.locale, '/register?t=pr#/3')"><img :src="'/assets_m/images/event/201230/' + $i18n.locale + '/p2.png'"></a></div>
              <div><img :src="'/assets_m/images/event/201230/' + $i18n.locale + '/p3.png'"></div>
              <div><a :href="helper.langUrl($i18n.locale, '/register?t=pr#/3')"><img :src="'/assets_m/images/event/201230/' + $i18n.locale + '/p4.png'"></a></div>
