    ...
    <div class="wrap">
                ...
                <div class="footer__subscribe">
                    ...
                    <form action="">
                        <div class="subscribe-form">
                            <input type="text" :placeholder="$t('enterYourEmailAddress')"/>
      ...
      <div class="footer__bottom">
        ...
        <p class="footer__copyright">
          ...
          copyright@beatsomeone 2020 .All Right reserved.<br/>
          (주)덤덤
        </p>
      </div>
    </div>
