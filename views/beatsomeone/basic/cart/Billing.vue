        ...
        <section class="main__section1" style="margin-bottom:160px;">
          ...
          <div class="wrap">
            ...
            <div class="row">
              ...
              >
                <div class="number">{{ selectedItems }}</div>
                {{$t('selectedItems')}}
              </div>
            </div>
            <div class="row">
                          ...
                          >
                            <div>
                              <button class="playList__item--button">
                                ...
                                >{{ formatPrice(item.detail[0].cde_price, item.detail[0].cde_price_d, true) }}</div>
                              </button>
                          ...
                          >
                            <div>
                              <button class="playList__item--button">
                                ...
                                >{{ formatPrice(item.detail[0].cde_price_2, item.detail[0].cde_price_d_2, true) }}</div>
                              </button>
            ...
            <div v-else>
              ...
              >
                <button class="btn btn--gray" @click="goBack">{{$t('back')}}</button>
                <button type="button" class="btn btn--submit" @click="procFreebeatPay">{{$t('pay')}}</button>
              </div>
            </div>
          </div>
        </section>
...
export default {
  ...
  data: function () {
    return {
      ...
      paypal: {
        sandbox:
          "AQRhzAlMZbwjG9B47YjqzJsQMmkQG6I4BA5hYiJjDFKiW2ysRUPkmKCInxmvCQ7Ij7zixTA_ZlPk8nC3",
        production:
          "AQnRlgkRT0pVUuORozmUa2qd6nOJH2BBvCvg8miFYWVpueRjfM4oepwZ5GfNOkfqznCrVbbriZSC83Z3",
      },
      paypalBtnStyle: {
        label: "pay",
        size: "large",
