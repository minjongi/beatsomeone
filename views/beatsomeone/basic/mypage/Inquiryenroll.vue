                ...
                <div class="row">
                    ...
                    <div class="data">
                        <div class="input_wrap col">
                            <input v-model="post_title" class="inputbox" type="text" placeholder="Please enter your title about problem..." />
                        </div>
                    </div>
                </div>
...
<!--                </div>-->
                ...
                <div class="row">
                    ...
                    <div class="data">
                        <textarea v-model="post_content" class="firstname" rows="10" placeholder="Please decribe your problem detaily..."></textarea>
                    </div>
                </div>
