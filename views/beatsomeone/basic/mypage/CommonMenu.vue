<template>
    <div class="row">
        <ul class="menu">
            ...
            <li :class="{'active':current === 'list_item'}" @click="goPage('list_item')" v-show="groupType == 'SELLER'">{{$t('productList')}}</li>
            ...
            <li :class="{'active':current === 'seller'}" @click="goPage('seller')" v-if="false" v-show="groupType == 'SELLER'">{{$t('settlementHistory')}}</li>
            <li :class="{'active':current === 'sellerreg'}" @click="goPage('sellerreg')" v-if="false" v-show="groupType == 'CUSTOMER'">{{$t('sellerRegister')}}</li>
            <li :class="{'active':current === 'inquiry'}" @click="goPage('inquiry')" v-if="false">{{$t('support1')}}
                <ul class="menu">
