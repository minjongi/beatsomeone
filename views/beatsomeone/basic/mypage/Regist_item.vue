                            ...
                            <div class="form-item">
                                ...
                                <div class="input nInput">
                                    <label for="c_no" class="checkbox">
                                        <input type="radio" name="officially" hidden id="c_no" value="0"
                                               v-model.number="item.officially_registered"/>
                                        <span></span> {{ $t('lang5') }}
                                    </label>
                                    <label for="c_yes" class="checkbox">
                                        <input type="radio" name="officially" hidden id="c_yes" value="1"
                                               v-model.number="item.officially_registered"/>
                                        <span></span> {{ $t('lang6') }}
                                    </label>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label class="form-item">
                                    ...
                                    <div class="input">
                                        <textarea v-model.trim="item.cit_content"
