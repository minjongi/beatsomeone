...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            toggleWish() {
                // Http.post(`/item/${this.item.cit_id}`).then(
                //   (r) => {
                //     if (r === true) {
                ...
                //   }
                // );
                if (+this.item.is_wish === 0) {
                    let formData = new FormData();
                    formData.append('stype', 'wish');
                    ...
                    axios.get(`/cmallact/wishlist_delete_by_cit_id/${this.item.cit_id}`)
                        .then(res => res.data)
                        .then(data => {
                            if (data.status === true) {
                                this.item.is_wish = this.item.is_wish === "1" ? "0" : "1";
                                this.item.cit_wish_count = data.count;
                            }
                        })
                }
            },
