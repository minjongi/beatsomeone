...
<table class="table table-striped">
	...
	?>
		<tr>
			...
			<td>
				<button class="btn btn-xs btn-danger btn-one-delete" type="button" data-one-delete-url = "<?php echo element('delete_url', $result); ?>"><span class="fa fa-trash"></span></button>
			</td>
		</tr>
	<?php
		}
