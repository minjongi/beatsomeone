    ...
    <div class="member-modify">
        ...
        <div class="card mb-4">
            <div class="card-body p-5">
                ...
                <div class="form-group row">
                    <label class="col-form-label col-4">{{ $t('userGroup') }}</label>
                ...
                <div class="form-group row">
                    <label class="col-form-label col-4">{{ $t('password') }}</label>
                    <div class="col-8 align-self-center">
                        <button class="btn btn-primary w-50" data-toggle="modal" data-target="#change-password-modal">
                            {{$t('changePassword')}}
                        </button>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-4">{{ $t('yourType') }}</label>
                    <div class="col-8 align-self-center">
                ...
                <div class="form-group row">
                    <label class="col-form-label col-4">{{ $t('realName') }}</label>
                    <div class="col-8">
                        <div class="row">
                            <div class="col-6">
                ...
                <div class="form-group row">
                    <label class="col-form-label col-4">City of Residence, State</label>
                    <div class="col-8">
                        <input class="form-control" type="text" v-model="mem_address1" />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-4">{{$t('bio')}}</label>
                    <div class="col-8">
                        <textarea class="form-control" type="text" v-model="mem_profile_content"></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-4">{{$t('linkedAccount')}}</label>
                    <div class="col-8">
        ...
        <div class="row justify-content-center">
            <div class="col-3">
                <button class="btn btn-block btn-warning btn-lg" @click="saveData">{{ $t('save') }}</button>
            </div>
        </div>
