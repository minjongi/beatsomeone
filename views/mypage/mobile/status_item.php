...
<?php $this->managelayout->add_css('/dist/m_status_item.css'); ?>
<?php $this->managelayout->add_js('/dist/chunk-vendors.js'); ?>
<?php $this->managelayout->add_js('/dist/chunk-common.js'); ?>
<?php $this->managelayout->add_js('/dist/m_status_item.js'); ?>
...
<div class="mypage" >
    <ul class="nav nav-tabs">
        ...
        <?php if($this->member->item('mem_usertype') == 2) { ?>
            ...
            <li class="active"><a href="<?php echo site_url('mypage/status_item'); ?>" title="판매내역">판매내역</a></li>
        <?php } ?>
