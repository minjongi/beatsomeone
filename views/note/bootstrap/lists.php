	...
	<table class="table table-striped mt20">
		...
		?>
			<tr>
				...
				<td><a href="<?php echo site_url('note/view/' . element('type', $view) . '/' . element('nte_id', $result)); ?>"><?php echo element('nte_read_datetime', $result) > '1000-01-01 00:00:00' ? display_datetime(element('nte_read_datetime', $result), 'full') : '<span class="text-danger">아직 읽지 않음</span>'; ?></a></td>
