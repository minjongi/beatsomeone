            ...
            foreach (element('orderdetail', $view) as $row) {
              ...
              <tr>
                ...
                <!--						<input type="checkbox" id="ct_chk_-->
                  <?php //echo $i; ?><!--" class="product_chk" name="chk[]" value="--><?php //echo $i; ?><!--">-->
                ...
                <td><a href="<?php echo cmall_item_url(element('cit_key', element('item', $row))); ?>"
                       target="_blank"><img
                        ...
                        title="<?php echo html_escape(element('cit_name', element('item', $row))); ?>"/></a></td>
                <td colspan="2"><a href="<?php echo cmall_item_url(element('cit_key', element('item', $row))); ?>"
                ...
                <td>
                  ...
                  <div
                    ...
                    <input type="number" name="cod_download_days[<?php echo $i; ?>]" class="form-control"
...
<!--              --><?php //} ?>
      ...
      <div class="cor_admin_memo_box">
        ...
        <div class="tbl_wrap">
          ...
          <textarea name="cor_admin_memo" id="cor_admin_memo" rows="8"
