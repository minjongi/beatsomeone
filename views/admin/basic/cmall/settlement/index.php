    ...
    <div class="box-table">
        ...
        <div class="box-table-header">
            ...
            <div class="btn-group pull-right" role="group" aria-label="...">
                <button type="button" class="btn btn-outline btn-primary btn-sm" onclick="doSettlement()">정산하기</button>
                ...
                if (element('list', element('data', $view))) {
                    foreach (element('list', element('data', $view)) as $result) {
                        ...
                        <tr>
                            ...
                            <td><?php echo display_datetime(element('csh_status', $result), 'full'); ?></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
