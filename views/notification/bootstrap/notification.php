		...
		<table class="table clearfix">
			<thead>
				<tr>
					...
					<th class="text-center">알림시간</th>
					<th class="text-center">읽은시간</th>
			...
			?>
				<tr>
					...
					<td class="text-center">
						<button class="btn btn-xs btn-danger btn-one-delete" type="button" data-one-delete-url = "<?php echo element('delete_url', $result); ?>"><i class="fa fa-trash"></i></button>
					</td>
				</tr>
			<?php
				}
