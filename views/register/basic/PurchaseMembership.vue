    ...
    <div class="container accounts accounts--result">
        ...
        <div class="login accounts__defaultLayout">
            <div class="accounts__switch">
                <span class="accounts__switch-bg" style="width: 450px"></span>
                <label>
            ...
            <div class="accounts__plan-price" v-if="info.group">
                <h2>
                    <span>{{
                            ...
                            info.billTerm === 'monthly' ? ($i18n.locale === 'en' ? info.group.mgr_monthly_cost_d : info.group.mgr_monthly_cost_w) : ($i18n.locale === 'en' ? info.group.mgr_year_cost_d : info.group.mgr_year_cost_w)
                        }}</span>
                </h2>
            </div>
